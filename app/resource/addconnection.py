...
class AddConnetion(Resource):
    ...
    def post(self):
        ...
        if self.connection_models.get_connection_by_ip(args['ip']) != None:
        ...
        self.connection_models.create_connection(args['name'], args['ip'], int(args['port']), args['username'], args['password'], args['id'])
        return {'reply':True}